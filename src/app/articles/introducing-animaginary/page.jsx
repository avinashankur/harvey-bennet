    ...
    <div className="article_page">
      <div className="mx-auto max-w-2xl leading-7">
        ...
        <p className="clr_secondary my-6">
          ...
          cupiditate. Obcaecati, doloremque non.{" "}
          <Link
            href="/"
            className="text-teal-500 font-medium underline decoration-teal-800 hover:decoration-teal-500"
          >
            Voluptas
          </Link>{" "}
          quos esse, eius illo facere tempore aspernatur! Deleniti incidunt quod
          expedita itaque architecto iure eligendi blanditiis praesentium!
        </p>
        <p className="clr_secondary my-6">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat,
          veniam. Veritatis sit
          <Link
            href="/"
            className="text-teal-500 font-medium underline decoration-teal-800 hover:decoration-teal-500"
          >
          ...
          recusandae aspernatur? Doloremque, quod numquam unde rerum et neque
          maxime recusandae?
        </p>

        <h2 className="font-bold text-xl mt-16">
          Lethaei Pindumve me quae dinumerat Pavor
        </h2>
        <p className="clr_secondary my-6">
          Idem se saxa fata pollentibus geminos; quos pedibus. Est urnis Herses
          omnes nec divite: et ille illa furit sim verbis Cyllenius.
        </p>
        ...
        <p className="clr_secondary my-6">
          ...
          rubuerunt confine desuetaque. Sanguine anteit emerguntque expugnacior
          est pennas iniqui ecce haeret genus: peiora imagine fossas{" "}
          <Link
            href="/"
            className="text-teal-500 font-medium underline decoration-teal-800 hover:decoration-teal-500"
          >
          ...
          Cephisos formosa! Refugitque amata refelli supplex. Summa brevis
          vetuere tenebas, hostes vetantis, suppressit, arreptum regna. Postquam
          conpescit iuvenis <b>habet</b> corpus, et erratica, perdere, tot mota
          ars talis.
        </p>
      </div>
    </div>
