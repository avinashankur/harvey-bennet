      ...
      <div className="clr_border flex mt-16 border-l pl-5 text-sm gap-2">
        ...
        <div className="basis-[80%] max-w-xl">
          <UsesCard
            ...
            desc="I was using an Intel-based 16&quot; MacBook Pro prior to this and the difference is night and day. I&apos;ve never heard the fans turn on a single time, even under the incredibly heavy loads I put it through with our various development environments and AI model training."
          />
          <UsesCard
            title="Apple Pro Display XDR (Standard Glass)"
            desc="The only display on the market if you want something HiDPI and bigger than 27&quot;. When you&apos;re working on complex web applications and need to see multiple code windows simultaneously, every pixel you can get counts."
          />
          <UsesCard
